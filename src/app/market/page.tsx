...
const MarketPage = () => {
    ...
    useEffect(() => {
        ...
        // Delay chart creation slightly to ensure theme colors are loaded
        const timer = setTimeout(() => {
            ...
            createChart(monthlyChartRef, {
                ...
                options: {
                    ...
                    scales: { y: { beginAtZero: true, grid: { color: `hsla(${foregroundColor}, 0.1)`}, title: { display: true, text: 'Cumulative Gain (%)', color: `hsl(${foregroundColor})` }, ticks: { color: `hsl(${mutedForegroundColor})` } }, x: { grid: { display: false }, ticks: { color: `hsl(${mutedForegroundColor})` } } }
                }
            });
            ...
            createChart(investmentReturnsChartRef, {
                ...
                options: { responsive: true, maintainAspectRatio: false, plugins: { title: { display: true, text: 'Illustrative Long-term Investment Returns (%)', font: { size: 16 }, color: `hsl(${foregroundColor})` }, legend: { position: 'bottom', labels: { color: `hsl(${foregroundColor})` } } }, scales: { y: { beginAtZero: true, grid: { color: `hsla(${foregroundColor}, 0.1)`}, title: { display: true, text: 'Cumulative Return (%)', color: `hsl(${foregroundColor})` }, ticks: { color: `hsl(${mutedForegroundColor})` } }, x: { grid: { display: false }, ticks: { color: `hsl(${mutedForegroundColor})` } } } }
            });
            ...
            createChart(ipoPerformanceChartRef, {
                ...
                options: { responsive: true, maintainAspectRatio: false, plugins: { title: { display: true, text: 'Illustrative IPO Performance Patterns (%)', font: { size: 16 }, color: `hsl(${foregroundColor})` }, legend: { position: 'bottom', labels: { color: `hsl(${foregroundColor})` } } }, scales: { y: { beginAtZero: false, grid: { color: `hsla(${foregroundColor}, 0.1)`}, title: { display: true, text: 'Return (%)', color: `hsl(${foregroundColor})` }, ticks: { color: `hsl(${mutedForegroundColor})` } }, x: { grid: { display: false }, ticks: { color: `hsl(${mutedForegroundColor})` } } } }
            });
            ...
            createChart(monteCarloChartRef, {
                ...
                options: { responsive: true, maintainAspectRatio: false, plugins: { title: { display: true, text: 'Portfolio Simulation (Indexed to 100)', font: { size: 16 }, color: `hsl(${foregroundColor})` }, legend: { position: 'bottom', labels: { color: `hsl(${foregroundColor})` } } }, scales: { y: { beginAtZero: false, grid: { color: `hsla(${foregroundColor}, 0.1)`}, title: { display: true, text: 'Value (Indexed)', color: `hsl(${foregroundColor})` }, ticks: { color: `hsl(${mutedForegroundColor})` } }, x: { grid: { display: false }, ticks: { color: `hsl(${mutedForegroundColor})` } } } }
            });
